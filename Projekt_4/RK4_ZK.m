...
s = 0.8;%korekta dlugosci kroku
beta = 1.5; %wspolcznniki maksymalnego wzrostu korku w jednej iteracji
i=1;
t(i) = T0;
...
while(t(i) <= Tk)
    ...
    tmp1 = x1 + (1/6)*h*(k11 + 2*k21 + 2*k31 + k41);
    tmp2 = x2 + (1/6)*h*(k12 + 2*k22 + 2*k32 + k42);
